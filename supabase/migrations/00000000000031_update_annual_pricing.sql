-- =========================================================================
-- El plan anual sube de $1,499 a $2,990 (mantiene la misma proporción de
-- descuento: 2 meses gratis) tras el ajuste del mensual a $299. Actualiza
-- el cálculo de MRR del panel súper admin — resto de la función sin
-- cambios respecto a 00000000000030_update_mrr_pricing.sql.
-- =========================================================================
...
begin
  ...
  select coalesce(sum(case when plan = 'monthly' then 299.00 else 2990.00 / 12.0 end), 0)
    into v_mrr
